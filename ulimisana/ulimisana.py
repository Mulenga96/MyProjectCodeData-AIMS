...
popSize          : The preferred community population size 
NoOfFamilies     : The preferred number of families in a community
fam_aveThreshold : The average threshold to show family is well off (range is [0,1])
com_aveThreshold : The average threshold to show community is well off (range is [0,1])
...
Trustworthiness epsilon: Trustworthiness of an advisor    
r              : Trust rating of an advisor
trustThreshold : Trust Threshold for a family to become an advisor (range is [0,1])


objFunction   : MalariaCost Function
...
def ulimisana(time_iter,popSize,NoOfFamilies,ageAverage,ageStdev,
    ...
    ageAverage       : Average age of individuals in each family
    ageStdev         : Standard Deviation of age per family
    objFunction      : The function to be evaluated (MalariaCost Function)
    dim              : Dimensions of the objective function
    lb               : Lower Boundary
    ub               : Upper Boundary
    sigFun_term      : [no_tran_term, tanh, logistic, arctan, gudermanannian, algebraic, erf]
    ...
    ## Trustworthiness epsilon: Trustworthiness of an individual 
    r               : Trust rating of an individual
    ...
    x_info      : Gives information about individual characteristics (Age and Family ID)
    x_pos       : Individual Position
    ind_val     : Individual Payoffs/ Objective Value
    fam_val     : Family Payoffs (Ubuntu Incentive)
    comm_val    : Community Payoff (Ubuntu Incentive)
    adv_trust   : Trust towards advisors
    trust       : Trust towards all other families.
    """
