    ...
    for time_iter_idx in range(0,time_iter):  
        ...
        for i in famID:
            ...
            for j in df['IndPayoff'][df['Family']==i].index.tolist():
               ...
               bestIndIter = ind_payoffs[j].astype(float).idxmax(axis=0)   # The best iteration with maximum payoffs - Mulenga.
        ...
        #print('Best :', bestIndIter)  #My addition - Mulenga
        #print('Best Individual Position', bestIndposition)   #My addition - Mulenga
