...
def trustworthinessFunction(trustNetwork,adv_trustworthiness,trustThreshold,epsilon,r):
    ...
    Parameters:
    -----------
        trustNetwork : This is a dataframe that contains information about each family's network of advisors.
        ...
        epsilon         : Advisor's maximum acceptable level of error
        r               : Reputation of an individual
    ...
    ---------
        ...
        trustNetwork            : This is a dataframe showing the advisor's trust network
        ratings                 : This is a dataframe showing the ratings that each family has for the other families in the                                     community.
    """
    
    N_min = -1/(2*epsilon**2) * np.log((1-r)/2)  # Trustworthiness determination equation.
